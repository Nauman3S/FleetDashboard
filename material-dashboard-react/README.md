...
Fleet Management is based on Material Dashboard React
...
- Clone the repo: `git clone https://github.com/Nauman3S/FleetDashboardt.git`.
...
Supported latest versions of the following browsers:
